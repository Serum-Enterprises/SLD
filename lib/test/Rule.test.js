...
describe('Testing Rule', () => {
	...
	test('Testing debug', () => {
		...
		expect((new Rule([symbolSet], 'This Rule failed', new BaseSymbol('STRING', ';', null))).debug()).toEqual({ symbolSets: [symbolSet.debug()], throwMessage: 'This Rule failed', recoverSymbol: new BaseSymbol('STRING', ';', null).debug() });
	})
});